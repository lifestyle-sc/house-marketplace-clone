...
const EditListing = () => {
  ...
  useEffect(() => {
    if (listings && listings.userRef !== auth.currentUser.uid) {
      toast.error('Cannot edit this listings');
      navigate('/');
    }
  });
  ...
  useEffect(() => {
    ...
    const fetchListing = async () => {
      ...
      if (docSnap.exists()) {
        ...
        toast.error('Could not get this listings');
        navigate('/');
      }
    };
  ...
  // set signed in user to listings
  useEffect(() => {
  ...
  return (
    <div className="p-5 mb-14">
      <header className="mb-3">
        <h1 className="text-2xl font-black">Edit listing</h1>
      </header>
